...
public interface IAlunoService {
  ...
  List<AvaliacaoFisica> todasAvaliacoes(Long id);

  List<Aluno> getAllPorDataDeNascimento(String dataNasc);

  List<Aluno> getAllPorBairro(String bairro);

  List<Aluno> getAllPorNome(String nome);
}
